...
# Assign values
level_intro_description <- level_text$level_intro_description
level_intro_action <- level_text$level_intro_action
level_action_first_paragraph <- level_text$level_action_first_paragraph
level_action_action <- level_text$level_action_action
...
if (params$ice == "Issue") {
  first_paragraph <- paste0(
    ...
    " due to ", level_intro_description, pollutantExpansion, "."
  )
...
Persons with chronic underlying medical conditions or acute infections should `r level_intro_action` strenuous exercise until the warning is ended.
