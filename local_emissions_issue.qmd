...
# create file path for PDF output
 ...
 # Clean location name for file name
      ...
      if (params$burnRestrictions < 1) {  # no burn restriction
        ...
        output_file_name <- sprintf("%s_%s_%s_%s", tolower(params$ice), pollutant_clean, "obp", location_clean) 
...
if (params$burnRestrictions > 0) {
  cat(
    "Open burning restrictions are now in effect ", params$burnRestrictionArea,
