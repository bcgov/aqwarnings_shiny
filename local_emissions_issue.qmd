...
# Look up table for warning level - column name format: warning level_section_descriptor
tbl_level <- tribble(
  ~level,
  ~level_intro_description,
  ~level_intro_action,
  ~level_action_first_paragraph,
  ~level_action_action,
  "yellow", 
  "elevated ", 
  " postpone or reduce ", 
  "As air contaminant levels increase, health risks increase. Consider reducing or rescheduling",  
  " reduce or rescheudle ",
  "orange", 
  "very high levels of ", 
  " avoid ",
  "Dangerous levels of air contaminant pose threat to your health regardless of age or health status. Reschedule or cancel ",
  "avoid"
)
...
# Assign values
string_level_intro_description <- level_text$level_intro_description
string_level_intro_action <- level_text$level_intro_action
string_level_action_first_paragraph <- level_text$level_action_first_paragraph
string_level_action_action <- level_text$level_action_action
...
Persons with chronic underlying medical conditions or acute infections should `r string_level_intro_action` strenuous exercise until the warning is ended.
