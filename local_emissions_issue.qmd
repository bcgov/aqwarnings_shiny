...
bylaws <- if (params$location == "Burns Lake") {
  ...
  "Houston bylaw 947 restricts the use of wood burning appliances and open burning during air quality advisories:\n\n
  ...
  - **3.2**: No person shall conduct open burning or ignite or maintain any recreational fire if an air quality advisory has been issued.\n\n
  - **3.3**: If an air quality advisory is issued while a person is conducting open burning or 
...
open burning or extinguish the recreational fire as soon as possible.\n\n
  - Contact the Houston municipal office at [250-845-2238](tel:2508452238) for more information on woodstove and open burning restrictions."
...
Exposure to `r pollutantExpansion` is particularly a concern for infants, older adults, individuals with chronic conditions (such as asthma, COPD, heart disease, and diabetes) or respiratory infections, and those who are pregnant.
...
**For additional information about air quality in British Columbia:**
  ...
  [What's the air like today?](https://www.env.gov.bc.ca/epd/bcairquality/data/aqhi-table.html) {{< card_end >}} {{< card_start title="Provincal Air Quality Map" variant="info" logo="/assets/icon_air.svg" >}} Provincial air quality data refreshed every hour.
  
  [Latest air quality data](https://www.env.gov.bc.ca/epd/bcairquality/readings/find-stations-map.html) {{< card_end >}} {{< card_start title="Metro Vancouver Air Quality" variant="success" logo="/assets/icon_chart.svg" >}} Warnings and a map of air quality and weather data.
