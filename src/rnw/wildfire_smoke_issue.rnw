...
The next update will be available on \Sexpr{nextUpdateDateString} at and made available on the \href{https://aqwarnings.gov.bc.ca/}{Province's Air Quality Warning webpage}.
...
\item Check in on others who are in your care or live nearby who may be more likley to be impacted by wildfire smoke.
