...
logos_selected <- logos_list[logos_names_selected] # subset logo_list
...
if(params$outputFormat == "markdown"){
      ...
      for(logo_name in names(logos_selected)) {
        ...
        logo_path <- "logo](https://github.com/bcgov/aqwarnings/blob/main/frontend/assets/logo_"
        ...
        for(logo_name in names(logos_selected)) {
          ...
          logo_image_line <- c(logo_image_line, paste0("![", logo_name, logo_path, logos_selected[[logo_name]], ".png?raw=true)"))
