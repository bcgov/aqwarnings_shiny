...
params: 
  ...
  customMessage: ""
  burnRestrictions: 1   # 1 = Yes (Ben); 2 = Yes (Arvind)
  burnRestrictionArea: ""
...
# Set output file name
  output_file_name <- sprintf("%s_%s", tolower(params$ice), "burn_prohibition") 
  mandatory_text <- NULL
...
`r if (params$burnRestrictions == 0 | params$outputFormat == "pdf") ":::{.content-hidden}"`
...
`r if (params$burnRestrictions == 0 | params$outputFormat == "pdf") ":::"`
...
`r paste0("- ", burn_ban_md_temp)`
`r paste0("- ", mandatory_text)`
