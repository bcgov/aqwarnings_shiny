...
if (length(valid_locations) == 0) {
  stop("None of the specified locations are valid for this pollutant.")
}
...
colnames(pt2) <- pt2[1, ]
pt3 <- pt2[-c(1), ]  # drop row names and location name if only one location
