...
# create file path for PDF output
 ...
 # Clean location name for file name
      ...
      if (params$burnRestrictionStatus == 0) {  # no burn restriction
        ...
        mandatory_text <- paste0("Please see the [PDF version of this Air Quality Warning](", pdf_path, ") for the statutory decision-maker sign-off related to open burning restrictions.")
